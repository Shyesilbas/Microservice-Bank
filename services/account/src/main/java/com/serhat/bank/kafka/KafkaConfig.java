...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, AccountCreatedEvent> consumerFactory() {
        ...
        ErrorHandlingDeserializer<AccountCreatedEvent> valueDeserializer = new ErrorHandlingDeserializer<>(
                new JsonDeserializer<>(AccountCreatedEvent.class));

        configProps.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, AccountCreatedEvent.class);
